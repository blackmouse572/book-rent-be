...
import { UpdateGenreDto } from 'src/genre/dtos/update-genre.dto'; // Import the UpdateGenreDto
...
export class GenreService {
    ...
    async update(
        ...
        if (typeof updateGenreDto.quantity !== 'undefined') {
            genre.quantity = updateGenreDto.quantity;
        }
