...
export class GenreService {
    ...
    async findAllWithBooks(find?: any, options?: IDatabaseFindAllOptions): Promise<GenreEntity[]> {
        return this.genreRepository.findAll<GenreEntity>(find, options);
    }

    async getTotal(find?: any, options?: IDatabaseGetTotalOptions): Promise<number> {
